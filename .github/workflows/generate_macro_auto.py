...
WEEK_LABEL = f"Settimana dal {monday.day:02d} al {saturday.day:02d} {MESI[saturday.month]} {saturday.year}"
WEEK_SHORT = f"{monday.day:02d} {MESI_SHORT[monday.month]} – {saturday.day:02d} {MESI_SHORT[saturday.month]} {saturday.year}"
